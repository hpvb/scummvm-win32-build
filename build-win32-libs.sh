...
LIBICONV_OPTIONS="--enable-static"
EXPAT=expat-2.2.0
PCRE=pcre-8.38
...
LIBFLAC=flac-1.3.1
LIBFLAC_STATIC=flac-1.3.1
LIBFLAC_STATIC_OPTIONS="--disable-shared --enable-static"
...
for ARCH in 32 64; do
  ...
  for LIBNAME in LIBICONV EXPAT PCRE LIBFFI GETTEXT GLIB2_STATIC GLIB2 LIBPNG LIBJPEG LIBOGG LIBVORBIS LIBFLAC_STATIC LIBFLAC LIBFAAD LIBTHEORA LIBFREETYPE LIBSDL LIBMAD LIBMPEG2 FLUIDSYNTH; do
    eval LIB=\$${LIBNAME}
