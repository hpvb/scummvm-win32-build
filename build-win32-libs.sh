...
for ARCH in 32 64; do
  ...
  for LIBNAME in LIBICONV EXPAT PCRE LIBFFI GETTEXT GLIB2_STATIC GLIB2 LIBPNG LIBJPEG LIBOGG LIBVORBIS LIBFLAC LIBFAAD LIBTHEORA LIBFREETYPE LIBSDL LIBMAD LIBMPEG2 FLUIDSYNTH; do
    eval LIB=\$${LIBNAME}
